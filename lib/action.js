...
export const addContact = async(FormData) => {
    ...
    try {
        ...
        throw new Error ("Wystąpił błąd podczas dodawania kontaktu " + error)
    }
    revalidatePath("/")
    redirect("/")
}
...
export const updateContact = async (FormData) => {
    ...
    try {
        ...
        throw new Error("Wystąpił błąd podczas edycji kontaktu " + error)
    }
    revalidatePath("/")
    redirect("/")
}
...
export const deleteContact = async (FormData) => {
    ...
    try {
        ...
        throw new Error("Wystąpił błąd podczas usuwania kontaktu " + error)
